...
export interface ApiAppointmentAppointment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    appointment_location: Attribute.String & Attribute.Required;
...
export interface ApiClientClient extends Schema.CollectionType {
  ...
  attributes: {
    users_permissions_user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    stripe_customer: Attribute.Relation<
      'api::client.client',
      'oneToOne',
      'api::stripe-customer.stripe-customer'
    >;
    client_upload_bucket: Attribute.Relation<
      'api::client.client',
      'oneToOne',
      'api::client-upload-bucket.client-upload-bucket'
    >;
...
export interface ApiClientMessageClientMessage extends Schema.CollectionType {
...
export interface ApiClientUploadBucketClientUploadBucket
  extends Schema.CollectionType {
  collectionName: 'client_upload_buckets';
  info: {
    singularName: 'client-upload-bucket';
    pluralName: 'client-upload-buckets';
    displayName: 'Client Upload Bucket';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiInvoiceInvoice extends Schema.CollectionType {
  ...
  attributes: {
    stripe_customer: Attribute.Relation<
      ...
      'api::stripe-customer.stripe-customer'
    >;
    invoice_number: Attribute.UID & Attribute.Required;
    amount: Attribute.Decimal & Attribute.Required;
    status: Attribute.Enumeration<
      ['unpaid', 'partial-payment', 'paid-deposit', 'paid', 'recurring']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'unpaid'>;
    request_proposal: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::invoice.invoice',
...
export interface ApiServiceProductServiceProduct extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    Description: Attribute.Blocks & Attribute.Required;
    slug: Attribute.UID<'api::service-product.service-product', 'name'>;
    services: Attribute.Relation<
      'api::service-product.service-product',
      'oneToMany',
      'api::service.service'
    >;
...
export interface ApiStripeCustomerStripeCustomer extends Schema.CollectionType {
  ...
  attributes: {
    total_uploads: Attribute.Integer;
    stripe_customer_id: Attribute.String & Attribute.Required;
    plan_expires: Attribute.DateTime;
    plan_active: Attribute.Boolean & Attribute.DefaultTo<false>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::client-upload-bucket.client-upload-bucket': ApiClientUploadBucketClientUploadBucket;
      'api::contact-message.contact-message': ApiContactMessageContactMessage;
      'api::invoice.invoice': ApiInvoiceInvoice;
      'api::post.post': ApiPostPost;
      'api::service.service': ApiServiceService;
      'api::service-product.service-product': ApiServiceProductServiceProduct;
